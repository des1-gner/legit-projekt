...
#define UI_TAB_WIDTH		50
#define UI_TAB_HEIGHT		100
...
#define COL_WHITE			Color(60, 60, 60)
#define UI_COL_MAIN			Color(0, 100, 255, 255)
#define UI_COL_TabHover 	Color(60,60,60, 255)
