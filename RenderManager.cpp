...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "vermin_vibes", 14, 400, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::ESP, "vermin_vibes", 14, 500, 0, 0, FONTFLAG_OUTLINE);
